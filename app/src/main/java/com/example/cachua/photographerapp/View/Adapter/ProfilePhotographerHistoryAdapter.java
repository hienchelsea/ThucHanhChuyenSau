...
public class ProfilePhotographerHistoryAdapter extends RecyclerView.Adapter<ProfilePhotographerHistoryAdapter.ViewHolder> {
    private Context mContext;
    private ArrayList<OrdersModel> ordersModelArrayList;

    public ProfilePhotographerHistoryAdapter(Context mContext, ArrayList<OrdersModel> ordersModelArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view= layoutInflater.inflate(R.layout.layout_adapter_photographer_history,viewGroup,false);
        ProfilePhotographerHistoryAdapter.ViewHolder viewHolder = new ProfilePhotographerHistoryAdapter.ViewHolder(view);
        return viewHolder;
    }
