package com.example.photographer.hienoc.library;
...
import static com.example.photographer.hienoc.library.CompactCalendarHelper.getDayEventWith2EventsPerDay;
import static com.example.photographer.hienoc.library.CompactCalendarHelper.getDayEventWithMultipleEventsPerDay;
import static com.example.photographer.hienoc.library.CompactCalendarHelper.getEvents;
...
public class CompactCalendarControllerTest {
    ...
    public void testItDrawsDaysOnCalender(){
        ...
        for(int dayColumn = 0, dayRow = 0; dayColumn <= 6; dayRow++){
            ...
            if(dayColumn == 0){
                verify(canvas).drawText(ArgumentMatchers.eq(dayColumnNames[dayColumn]), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
            }else{
                int day = ((dayRow - 1) * 7 + dayColumn + 1) - 6;
                if( day > 0 && day <= 28){
                    verify(canvas).drawText(ArgumentMatchers.eq(String.valueOf(day)), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
                }
            }
        }
    }
    ...
    public void testItDrawsEventDaysOnCalendar(){
        ...
        verify(canvas, times(numberOfDaysWithEvents)).drawCircle(ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
    }
    ...
    public void testItDrawsMultipleEventDaysOnCalendar(){
        ...
        verify(canvas, times(numberOfDaysWithEvents * 2)).drawCircle(ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
    }
    ...
    public void testItDrawsMultipleEventDaysOnCalendarWithPlusIndicator(){
        ...
        verify(canvas, times(numberOfDaysWithEvents * 2)).drawLine(ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
    }
    ...
    public void testItDrawsEventDaysOnCalendarForCurrentMonth(){
        ...
        verify(canvas, times(numberOfDaysInMonth - 1)).drawCircle(ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
    }
    ...
    public void testItDrawsEventDaysOnCalendarWithSelectedDay(){
        ...
        verify(canvas, times(numberOfDaysWithEvents - 1)).drawCircle(ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
    }
    ...
    public void testItDrawsEventDaysOnCalendarForCurrentMonthWithSelectedDay(){
        ...
        verify(canvas, times(numberOfDaysInMonth - 2)).drawCircle(ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.anyFloat(), ArgumentMatchers.eq(paint));
    }
